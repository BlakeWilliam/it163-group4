<footer>
  <div class="container border-top">
    ...
    <div class="row mt-5 pt-4 border-top">
      ...
      <div class="col-md-6 ">
        <p class="mb-0 list unstyled"><small>
          <a class="mr-md-3" href="http://validator.w3.org/check/referer" target="_blank">Valid HTML</a>
        
          <a class="mr-md-3" href="disclaimer.php">Disclaimer</a>
          <a class="mr-md-3" href="http://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
      </div>
    </div>
    <div id="timer">
...
<!-- commented out while testing js file 
